...
impl Messages for CreateBearerResponse {
    ...
    fn unmarshal(buffer: &[u8]) -> Result<Self, GTPV2Error> {
        let mut message = CreateBearerResponse::default();
        match Gtpv2Header::unmarshal(buffer) {
            Ok(i) => message.header = i,
            Err(j) => return Err(j),
        }

        if message.header.msgtype != CREATE_BEARER_RESP {
...
fn test_create_bearer_resp_unmarshal() {
    ...
    let encoded: [u8; 109] = [
        0x48, 0x60, 0x00, 0x69, 0x09, 0x09, 0xa4, 0x56, 0x00, 0x00, 0x2f, 0x00, 0x02, 0x00, 0x02,
        0x00, 0x10, 0x00, 0x5d, 0x00, 0x3a, 0x00, 0x02, 0x00, 0x02, 0x00, 0x10, 0x00, 0x49, 0x00,
        0x01, 0x00, 0x05, 0x57, 0x00, 0x09, 0x02, 0x85, 0x3b, 0x95, 0x98, 0x5a, 0x3e, 0x99, 0x89,
        0x55, 0x50, 0x00, 0x16, 0x00, 0x2c, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5e, 0x00, 0x04,
        0x00, 0x01, 0x62, 0x9c, 0xc4, 0x03, 0x00, 0x01, 0x00, 0x11, 0x4e, 0x00, 0x14, 0x00, 0x80,
        0x80, 0x21, 0x10, 0x02, 0x00, 0x00, 0x10, 0x81, 0x06, 0x08, 0x08, 0x08, 0x08, 0x83, 0x06,
        0x0a, 0x40, 0xd0, 0x61,
    ];
    let decoded = CreateBearerResponse {
        header: Gtpv2Header {
            msgtype: CREATE_BEARER_RESP,
            piggyback: false,
            message_prio: None,
